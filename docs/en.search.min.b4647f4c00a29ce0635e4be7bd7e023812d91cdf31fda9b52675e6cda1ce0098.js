...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.0aff3d53d60d86e4cebd758d328c29283a2a8f01cb495afc35529462fe9f5fff.js',function(){input.required=false;search();});}
