...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.6a2826637a8b2175d68bd78da88e0cd75208f98d1bd3d9f3d8284fa606a9526b.js',function(){input.required=false;search();});}
