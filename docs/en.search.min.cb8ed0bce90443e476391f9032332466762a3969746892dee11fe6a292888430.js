...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ec0ba391b011c11810a0ca4edccab1db9bfc6c95daab64c5b03ec955da366cd4.js',function(){input.required=false;search();});}
